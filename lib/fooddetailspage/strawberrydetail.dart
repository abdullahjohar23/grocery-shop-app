...
class Strawberrydetail extends StatefulWidget {
    const Strawberrydetail({super.key});

    @override
    State<Strawberrydetail> createState() => _StrawberrydetailState();
}

class _StrawberrydetailState extends State<Strawberrydetail> {
    @override
